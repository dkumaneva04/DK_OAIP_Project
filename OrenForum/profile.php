...
<body>
    ...
    margin: 0px auto;" class="image__user" method="POST" enctype="multipart/form-data">
            <img src="image/<?=$response[0]['image']?>" style="border: 1px solid #000; cursor: pointer" width="200" height="300" alt="">
            <div class="hover">
                <input type="file" name="file_up" style="position: absolute; font-size: 10px; top: 30px; left: 5px; width: 200; height: 200px; cursor: pointer; opacity: 0.001; " required>
            </div>
