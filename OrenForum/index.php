...
$query = "SELECT * FROM files WHERE status = 'Одобрено'"; 
$result = mysqli_query($connect, $query);  
$resp = $result->fetch_all(MYSQLI_ASSOC); 
 
// использование данных $files
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container">
        ...
        <div class="item">
            ...
            <div class="data">
                <h2><?= $resp[$i]['name'] ?></h2>
                <p style="margin-bottom: 20px; word-wrap: break-word; width: 300px;"><?= $resp[$i]['description'] ?></p>
